package com.mansopresk.mansopresk01.pagenationproject;
...
import com.mansopresk.mansopresk01.pagenationproject.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addDataToList() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                for (int i = 0; i <= 30; i++) {
                    mStringList.add("Prathyusha : " + mLoadedItems);
                    mLoadedItems++;
                }
